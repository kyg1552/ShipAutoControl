...
BT_socket.connect(("98:D3:81:FD:6E:85", 1)) #소켓통신 연결
...
if __name__ == '__main__':
	...
	while frame_captured:
		...
		markers = detect_markers(frame)
                ...
                read_data = SER.readline() #초음파 거리 수신
		read_data = long(read_data) #수신된 값을 long변환
		print("distance=",read_data) #거리값 출력
